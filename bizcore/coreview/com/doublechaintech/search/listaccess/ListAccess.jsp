<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.listaccess.ListAccess'%>
...
<c:set var="ownerBeanName" value="listAccess" scope="request"/>
<c:set var="ownerClassName" value="ListAccess" scope="request"/>
...
<div class="row">
	...
	<% ListAccess result = (ListAccess)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="listAccess" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/listaccess/ListAccess$Summary.jsp" />
