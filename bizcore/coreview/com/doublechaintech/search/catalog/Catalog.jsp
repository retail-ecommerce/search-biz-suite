<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.catalog.Catalog'%>
...
<c:set var="ownerBeanName" value="catalog" scope="request"/>
<c:set var="ownerClassName" value="Catalog" scope="request"/>
...
<div class="row">
	...
	<% Catalog result = (Catalog)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#levelOneCategoryList" class="disabled"> ${userContext.localeMap['level_one_category']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="catalog" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/catalog/Catalog$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/site/Site$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["levelOneCategoryList"] or ignoreListAccessControl}'>
		<c:set var="levelOneCategoryList" value="${result.levelOneCategoryList}" scope="request"/>
		<c:set var="levelOneCategoryListName" value="levelOneCategoryList" scope="request"/>
		<div id="levelOneCategoryList" class="tab-pane fade sublist" refer-name="catalog">
			<sky:include page="com/doublechaintech/search/levelonecategory/LevelOneCategory$List.jsp"
					referName="catalog"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["productList"] or ignoreListAccessControl}'>
		...
		<div id="productList" class="tab-pane fade sublist" refer-name="catalog">
			<sky:include page="com/doublechaintech/search/product/Product$List.jsp"
					referName="catalog"/>
		</div>
	</c:if>
