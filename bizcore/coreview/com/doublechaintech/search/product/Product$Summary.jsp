...
<div class="col-xs-12 col-md-12 section">
	<b title="A Product"> 
		${userContext.localeMap['product']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['product.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['product.display_name']}</span>
