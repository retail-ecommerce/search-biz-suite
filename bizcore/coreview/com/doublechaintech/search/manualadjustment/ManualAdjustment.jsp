<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.manualadjustment.ManualAdjustment'%>
...
<c:set var="ownerBeanName" value="manualAdjustment" scope="request"/>
<c:set var="ownerClassName" value="ManualAdjustment" scope="request"/>
...
<div class="row">
	...
	<% ManualAdjustment result = (ManualAdjustment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="manualAdjustment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/manualadjustment/ManualAdjustment$Summary.jsp" />
	...
	<div class="row">
<c:set var="userOrder" value="${ result.userOrder}" scope="request" />
<sky:include page="com/doublechaintech/search/userorder/UserOrder$Info.jsp" />
