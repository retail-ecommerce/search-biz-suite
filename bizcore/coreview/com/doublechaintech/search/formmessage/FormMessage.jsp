<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.formmessage.FormMessage'%>
...
<c:set var="ownerBeanName" value="formMessage" scope="request"/>
<c:set var="ownerClassName" value="FormMessage" scope="request"/>
...
<div class="row">
	...
	<% FormMessage result = (FormMessage)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="formMessage" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/formmessage/FormMessage$Summary.jsp" />
