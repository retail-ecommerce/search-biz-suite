<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.productrecommendation.ProductRecommendation'%>
...
<c:set var="ownerBeanName" value="productRecommendation" scope="request"/>
<c:set var="ownerClassName" value="ProductRecommendation" scope="request"/>
...
<div class="row">
	...
	<% ProductRecommendation result = (ProductRecommendation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="productRecommendation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/productrecommendation/ProductRecommendation$Summary.jsp" />
...
<c:set var="product" value="${ result.product}" scope="request" />
<sky:include page="com/doublechaintech/search/product/Product$Info.jsp" />
