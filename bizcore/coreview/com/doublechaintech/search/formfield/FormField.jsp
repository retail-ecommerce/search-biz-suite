<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.formfield.FormField'%>
...
<c:set var="ownerBeanName" value="formField" scope="request"/>
<c:set var="ownerClassName" value="FormField" scope="request"/>
...
<div class="row">
	...
	<% FormField result = (FormField)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="formField" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/formfield/FormField$Summary.jsp" />
