<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.lineitem.LineItem'%>
...
<c:set var="ownerBeanName" value="lineItem" scope="request"/>
<c:set var="ownerClassName" value="LineItem" scope="request"/>
...
<div class="row">
	...
	<% LineItem result = (LineItem)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="lineItem" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/lineitem/LineItem$Summary.jsp" />
