<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.brand.Brand'%>
...
<sky:include page="com/doublechaintech/search/brand/Brand$Summary.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["productRecommendationList"] or ignoreListAccessControl}'>
		...
		<div id="productRecommendationList" class="tab-pane fade sublist" refer-name="brand">
