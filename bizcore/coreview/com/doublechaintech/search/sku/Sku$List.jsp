...
<c:if test="${param.referName ne 'active'}">
	<th>${userContext.localeMap['sku.active']}</th>
</c:if>
<c:if test="${param.referName ne 'basePrice'}">
	<th>${userContext.localeMap['sku.base_price']}</th>
</c:if>
<c:if test="${param.referName ne 'lastUpdateTime'}">
	<th>${userContext.localeMap['sku.last_update_time']}</th>
</c:if>
...
<c:if test="${param.referName ne 'active'}">	<td contenteditable='true' class='edit-value'  propertyToChange='active' storedCellValue='${item.active}' prefix='${ownerBeanName}Manager/updateSku/${result.id}/${item.id}/'>${item.active}</td>
</c:if><c:if test="${param.referName ne 'basePrice'}">	<td contenteditable='true' class='edit-value money'  propertyToChange='basePrice' storedCellValue='${item.basePrice}' prefix='${ownerBeanName}Manager/updateSku/${result.id}/${item.id}/'><fmt:formatNumber type="currency"  value="${item.basePrice}" /></td>
</c:if><c:if test="${param.referName ne 'lastUpdateTime'}">	<td contenteditable='true' class='edit-value'  propertyToChange='lastUpdateTime' storedCellValue='${item.lastUpdateTime}' prefix='${ownerBeanName}Manager/updateSku/${result.id}/${item.id}/'>${item.lastUpdateTime}</td>
</c:if>
				<td>
