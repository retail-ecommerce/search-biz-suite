<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.sku.Sku'%>
...
<c:set var="ownerBeanName" value="sku" scope="request"/>
<c:set var="ownerClassName" value="Sku" scope="request"/>
...
<div class="row">
	...
	<% Sku result = (Sku)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="sku" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/sku/Sku$Summary.jsp" />
