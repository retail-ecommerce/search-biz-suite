<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.orderpromotion.OrderPromotion'%>
...
<c:set var="ownerBeanName" value="orderPromotion" scope="request"/>
<c:set var="ownerClassName" value="OrderPromotion" scope="request"/>
...
<div class="row">
	...
	<% OrderPromotion result = (OrderPromotion)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="orderPromotion" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/orderpromotion/OrderPromotion$Summary.jsp" />
