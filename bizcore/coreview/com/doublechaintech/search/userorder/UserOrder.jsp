<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.userorder.UserOrder'%>
...
<sky:include page="com/doublechaintech/search/userorder/UserOrder$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/profile/Profile$Info.jsp" />

<c:set var="platform" value="${ result.platform}" scope="request" />
<sky:include page="com/doublechaintech/search/platform/Platform$Info.jsp" />
		...
		<div id="lineItemList" class="tab-pane fade sublist" refer-name="user_order">
			<sky:include page="com/doublechaintech/search/lineitem/LineItem$List.jsp"
					referName="userOrder"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["orderPromotionList"] or ignoreListAccessControl}'>
		...
		<div id="orderPromotionList" class="tab-pane fade sublist" refer-name="user_order">
			<sky:include page="com/doublechaintech/search/orderpromotion/OrderPromotion$List.jsp"
					referName="userOrder"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["manualAdjustmentList"] or ignoreListAccessControl}'>
		...
		<div id="manualAdjustmentList" class="tab-pane fade sublist" refer-name="user_order">
			<sky:include page="com/doublechaintech/search/manualadjustment/ManualAdjustment$List.jsp"
					referName="userOrder"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["shippingGroupList"] or ignoreListAccessControl}'>
		...
		<div id="shippingGroupList" class="tab-pane fade sublist" refer-name="user_order">
			<sky:include page="com/doublechaintech/search/shippinggroup/ShippingGroup$List.jsp"
					referName="userOrder"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["paymentGroupList"] or ignoreListAccessControl}'>
		...
		<div id="paymentGroupList" class="tab-pane fade sublist" refer-name="user_order">
			<sky:include page="com/doublechaintech/search/paymentgroup/PaymentGroup$List.jsp"
					referName="userOrder"/>
		</div>
	</c:if>
