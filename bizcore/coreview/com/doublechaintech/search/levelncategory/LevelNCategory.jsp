<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.levelncategory.LevelNCategory'%>
...
<c:set var="ownerBeanName" value="levelNCategory" scope="request"/>
<c:set var="ownerClassName" value="LevelNCategory" scope="request"/>
...
<div class="row">
	...
	<% LevelNCategory result = (LevelNCategory)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelNCategory" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/levelncategory/LevelNCategory$Summary.jsp" />
	...
	<div class="row">
<c:set var="levelTwoCategory" value="${ result.parentCategory}" scope="request" />
<sky:include page="com/doublechaintech/search/leveltwocategory/LevelTwoCategory$Info.jsp" />
		...
		<div id="productList" class="tab-pane fade sublist" refer-name="parent_category">
