<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.leveltwocategory.LevelTwoCategory'%>
...
<c:set var="ownerBeanName" value="levelTwoCategory" scope="request"/>
<c:set var="ownerClassName" value="LevelTwoCategory" scope="request"/>
...
<div class="row">
	...
	<% LevelTwoCategory result = (LevelTwoCategory)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#levelNCategoryList" class="disabled"> ${userContext.localeMap['level_n_category']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelTwoCategory" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/leveltwocategory/LevelTwoCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/levelonecategory/LevelOneCategory$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["levelNCategoryList"] or ignoreListAccessControl}'>
		<c:set var="levelNCategoryList" value="${result.levelNCategoryList}" scope="request"/>
		<c:set var="levelNCategoryListName" value="levelNCategoryList" scope="request"/>
		<div id="levelNCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/search/levelncategory/LevelNCategory$List.jsp"
