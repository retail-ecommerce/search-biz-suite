<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.formfieldmessage.FormFieldMessage'%>
...
<c:set var="ownerBeanName" value="formFieldMessage" scope="request"/>
<c:set var="ownerClassName" value="FormFieldMessage" scope="request"/>
...
<div class="row">
	...
	<% FormFieldMessage result = (FormFieldMessage)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="formFieldMessage" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/genericform/GenericForm$Info.jsp" />
