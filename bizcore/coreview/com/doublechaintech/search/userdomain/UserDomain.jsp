<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.userdomain.UserDomain'%>
...
<c:set var="ownerBeanName" value="userDomain" scope="request"/>
<c:set var="ownerClassName" value="UserDomain" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userDomain" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/search/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
