<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.objectaccess.ObjectAccess'%>
...
<c:set var="ownerBeanName" value="objectAccess" scope="request"/>
<c:set var="ownerClassName" value="ObjectAccess" scope="request"/>
...
<div class="row">
	...
	<% ObjectAccess result = (ObjectAccess)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="objectAccess" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/objectaccess/ObjectAccess$Summary.jsp" />
	...
	<div class="row">
<c:set var="userApp" value="${ result.app}" scope="request" />
<sky:include page="com/doublechaintech/search/userapp/UserApp$Info.jsp" />
