<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.platform.Platform'%>
...
<sky:include page="com/doublechaintech/search/platform/Platform$Summary.jsp" />
