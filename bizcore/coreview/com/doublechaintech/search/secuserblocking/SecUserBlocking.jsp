<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.secuserblocking.SecUserBlocking'%>
...
<c:set var="ownerBeanName" value="secUserBlocking" scope="request"/>
<c:set var="ownerClassName" value="SecUserBlocking" scope="request"/>
...
<div class="row">
	...
	<% SecUserBlocking result = (SecUserBlocking)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="secUserBlocking" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/secuserblocking/SecUserBlocking$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		<c:set var="secUserList" value="${result.secUserList}" scope="request"/>
		<c:set var="secUserListName" value="secUserList" scope="request"/>
		<div id="secUserList" class="tab-pane fade sublist" refer-name="blocking">
			<sky:include page="com/doublechaintech/search/secuser/SecUser$List.jsp"
					referName="blocking"/>
		</div>
	</c:if>
