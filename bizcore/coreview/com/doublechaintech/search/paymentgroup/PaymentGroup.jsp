<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.paymentgroup.PaymentGroup'%>
...
<c:set var="ownerBeanName" value="paymentGroup" scope="request"/>
<c:set var="ownerClassName" value="PaymentGroup" scope="request"/>
...
<div class="row">
	...
	<% PaymentGroup result = (PaymentGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="paymentGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/paymentgroup/PaymentGroup$Summary.jsp" />
