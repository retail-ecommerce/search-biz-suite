<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.shippinggroup.ShippingGroup'%>
...
<c:set var="ownerBeanName" value="shippingGroup" scope="request"/>
<c:set var="ownerClassName" value="ShippingGroup" scope="request"/>
...
<div class="row">
	...
	<% ShippingGroup result = (ShippingGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="shippingGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/shippinggroup/ShippingGroup$Summary.jsp" />
