<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.site.Site'%>
...
<c:set var="ownerBeanName" value="site" scope="request"/>
<c:set var="ownerClassName" value="Site" scope="request"/>
...
<div class="row">
	...
	<% Site result = (Site)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="site" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/site/Site$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/platform/Platform$Info.jsp" />
		...
		<div id="catalogList" class="tab-pane fade sublist" refer-name="site">
			<sky:include page="com/doublechaintech/search/catalog/Catalog$List.jsp"
					referName="site"/>
		</div>
	</c:if>
