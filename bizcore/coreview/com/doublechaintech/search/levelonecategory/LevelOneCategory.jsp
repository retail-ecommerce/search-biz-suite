<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.levelonecategory.LevelOneCategory'%>
...
<c:set var="ownerBeanName" value="levelOneCategory" scope="request"/>
<c:set var="ownerClassName" value="LevelOneCategory" scope="request"/>
...
<div class="row">
	...
	<% LevelOneCategory result = (LevelOneCategory)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#levelTwoCategoryList" class="disabled"> ${userContext.localeMap['level_two_category']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelOneCategory" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/levelonecategory/LevelOneCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/catalog/Catalog$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["levelTwoCategoryList"] or ignoreListAccessControl}'>
		<c:set var="levelTwoCategoryList" value="${result.levelTwoCategoryList}" scope="request"/>
		<c:set var="levelTwoCategoryListName" value="levelTwoCategoryList" scope="request"/>
		<div id="levelTwoCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/search/leveltwocategory/LevelTwoCategory$List.jsp"
					referName="parentCategory"/>
		</div>
	</c:if>
