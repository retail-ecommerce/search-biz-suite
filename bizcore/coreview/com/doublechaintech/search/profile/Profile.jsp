<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.profile.Profile'%>
...
<sky:include page="com/doublechaintech/search/profile/Profile$Summary.jsp" />
...
<sky:include page="com/doublechaintech/search/platform/Platform$Info.jsp" />
		...
		<div id="userOrderList" class="tab-pane fade sublist" refer-name="user">
