<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.userwhitelist.UserWhiteList'%>
...
<c:set var="ownerBeanName" value="userWhiteList" scope="request"/>
<c:set var="ownerClassName" value="UserWhiteList" scope="request"/>
...
<div class="row">
	...
	<% UserWhiteList result = (UserWhiteList)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userWhiteList" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/userwhitelist/UserWhiteList$Summary.jsp" />
