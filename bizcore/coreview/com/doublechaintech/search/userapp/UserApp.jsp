<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.userapp.UserApp'%>
...
<c:set var="ownerBeanName" value="userApp" scope="request"/>
<c:set var="ownerClassName" value="UserApp" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userApp" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/userapp/UserApp$Summary.jsp" />
	...
	<div class="row">
<c:set var="secUser" value="${ result.secUser}" scope="request" />
<sky:include page="com/doublechaintech/search/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/search/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		<c:set var="objectAccessList" value="${result.objectAccessList}" scope="request"/>
		<c:set var="objectAccessListName" value="objectAccessList" scope="request"/>
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/search/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
