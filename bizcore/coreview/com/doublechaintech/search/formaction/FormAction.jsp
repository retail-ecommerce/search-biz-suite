<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/search/formaction/FormAction$Summary.jsp" />
