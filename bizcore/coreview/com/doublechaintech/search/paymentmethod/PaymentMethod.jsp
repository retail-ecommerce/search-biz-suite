<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.paymentmethod.PaymentMethod'%>
...
<c:set var="ownerBeanName" value="paymentMethod" scope="request"/>
<c:set var="ownerClassName" value="PaymentMethod" scope="request"/>
...
<div class="row">
	...
	<% PaymentMethod result = (PaymentMethod)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="paymentMethod" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/paymentmethod/PaymentMethod$Summary.jsp" />
