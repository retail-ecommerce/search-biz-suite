<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.shippingaddress.ShippingAddress'%>
...
<c:set var="ownerBeanName" value="shippingAddress" scope="request"/>
<c:set var="ownerClassName" value="ShippingAddress" scope="request"/>
...
<div class="row">
	...
	<% ShippingAddress result = (ShippingAddress)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="shippingAddress" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/shippingaddress/ShippingAddress$Summary.jsp" />
