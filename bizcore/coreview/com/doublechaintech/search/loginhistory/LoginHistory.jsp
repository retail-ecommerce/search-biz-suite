<%@ page import='java.util.*,com.doublechaintech.search.*,com.doublechaintech.search.loginhistory.LoginHistory'%>
...
<c:set var="ownerBeanName" value="loginHistory" scope="request"/>
<c:set var="ownerClassName" value="LoginHistory" scope="request"/>
...
<div class="row">
	...
	<% LoginHistory result = (LoginHistory)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="loginHistory" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/search/loginhistory/LoginHistory$Summary.jsp" />
