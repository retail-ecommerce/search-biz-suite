...
import com.doublechaintech.search.SearchUserContextImpl;
import com.doublechaintech.search.LoginForm;
import com.doublechaintech.search.BaseEntity;
import com.doublechaintech.search.CommonError;
import com.doublechaintech.search.DAOGroup;
import com.doublechaintech.search.ManagerGroup;

import com.doublechaintech.search.UserContextImpl;
import com.doublechaintech.search.userapp.UserApp;
import com.doublechaintech.search.SearchUserContext;
import com.doublechaintech.search.userapp.*;
import com.doublechaintech.search.listaccess.*;
import com.doublechaintech.search.objectaccess.*;
import com.doublechaintech.search.SearchChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(SearchUserContext userContext){
    ...
    public Object resetPassword(SearchUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(SearchUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(SearchUserContext userContext,
    ...
    public SecUser manage(SearchUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(SearchUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(SearchUserContext userContext) {
    ...
    protected Object gotoApp(SearchUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(SearchUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(SearchUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(SearchUserContext userContex, int length){
    ...
    protected String getBeanName(SearchUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(SearchUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(SearchUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(SearchUserContext userContext, UserApp app){
    ...
    public Object home(SearchUserContext userContext) {
    ...
    public Object loginWithEmail(SearchUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(SearchUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(SearchUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(SearchUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(SearchUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(SearchUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(SearchUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(SearchUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(SearchUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        SearchUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected SearchChecker checker;
    public SearchChecker getChecker(){
        return checker;
    }
    
    public void setChecker(SearchChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((SearchChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected SearchUserContextImpl createNewConext(String path) {

        return new SearchUserContextImpl();
    ...
    public Object checkOtherLogin(SearchUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(SearchUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(SearchUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(SearchUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(SearchUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(SearchUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(SearchUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
