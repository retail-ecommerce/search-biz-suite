...
这个类已经被配置到了相应的Spring配置文件 WEB-INF/search_custom_src/META-INF/search_custom.xml 中，
...
public class SecUserBlockingCustomManagerImpl extends SecUserBlockingManagerImpl{
