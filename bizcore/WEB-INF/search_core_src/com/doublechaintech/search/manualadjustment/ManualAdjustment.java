...
@JsonSerialize(using = ManualAdjustmentSerializer.class)
public class ManualAdjustment extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="ManualAdjustment";
	...
	public 	ManualAdjustment(String name, int amount, int threadHold, String type, UserOrder userOrder)
	{
		setName(name);
		setAmount(amount);
	...
	public ManualAdjustment updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public ManualAdjustment updateName(String name){
		this.mName = trimString(name);;
		this.changed = true;
		return this;
	}
	...
	public ManualAdjustment updateAmount(int amount){
		this.mAmount = amount;;
		this.changed = true;
		return this;
	}
	...
	public ManualAdjustment updateThreadHold(int threadHold){
		this.mThreadHold = threadHold;;
		this.changed = true;
		return this;
	}
	...
	public ManualAdjustment updateType(String type){
		this.mType = trimString(type);;
		this.changed = true;
		return this;
	}
	...
	public ManualAdjustment updateUserOrder(UserOrder userOrder){
		this.mUserOrder = userOrder;;
		this.changed = true;
		return this;
	}
	...
	public ManualAdjustment updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof ManualAdjustment){
		
		
			ManualAdjustment dest =(ManualAdjustment)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("ManualAdjustment{");
