...
public interface LevelNCategoryManager{
	...
	//public  ProductManager getProductManager(SearchUserContext userContext, String levelNCategoryId, String displayName, String brandId, String origin, String catalogId, String remark, String lastUpdateTime ,String [] tokensExpr)  throws Exception;
