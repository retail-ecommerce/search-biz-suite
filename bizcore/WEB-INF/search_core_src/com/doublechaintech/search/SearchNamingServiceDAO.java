...
public class SearchNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("Catalog", new String[]{"catalog_data","display_name"});
		namingTableMap.put("LevelOneCategory", new String[]{"level_one_category_data","display_name"});
		namingTableMap.put("LevelTwoCategory", new String[]{"level_two_category_data","display_name"});
		namingTableMap.put("LevelNCategory", new String[]{"level_n_category_data","display_name"});
		namingTableMap.put("Brand", new String[]{"brand_data","brand_name"});
		namingTableMap.put("Product", new String[]{"product_data","display_name"});
		namingTableMap.put("ProductRecommendation", new String[]{"product_recommendation_data","display_name"});
		namingTableMap.put("Sku", new String[]{"sku_data","display_name"});
