...
public class SearchExceptionJsonSerializer extends  JsonSerializer<SearchException> {
	...
	@Override
	public void serialize(SearchException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, SearchException exception,
	...
	protected void writeStartObject(SearchException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(SearchException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,SearchException exception,
	...
	protected void writeStringField(String key, String value,
			JsonGenerator jgen, SerializerProvider provider) throws IOException {
	...
	protected void writeMessageList(String fieldName,SearchException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
