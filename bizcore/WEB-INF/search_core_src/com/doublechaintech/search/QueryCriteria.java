...
public class QueryCriteria extends BaseEntity {
	...
	/**
	 *
customList.searchField=name
customList.searchVerb=startsWith/eq/contains/endsWith/range(between and)/between
customList.searchValue=Philip
customList.searchResultOrderBy=name
customList.searchResultOrder=desc/asc
	...
	protected static String getOptionsValue(String listName, String key,Map<String, Object >options){
