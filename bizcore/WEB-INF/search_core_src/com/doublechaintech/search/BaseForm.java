...
public class BaseForm extends GenericForm{
	...
	protected FormField idFromProductRecommendation(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Id");
		field.setLocaleKey("product_recommendation.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField brandIdFromProductRecommendation(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Brand");
		field.setLocaleKey("product_recommendation.brand");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("Brand");
	...
	protected FormField originFromProductRecommendation(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Origin");
		field.setLocaleKey("product_recommendation.origin");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField productIdFromProductRecommendation(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Product");
		field.setLocaleKey("product_recommendation.product");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
	...
	protected FormField remarkFromProductRecommendation(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Remark");
		field.setLocaleKey("product_recommendation.remark");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField lastUpdateTimeFromProductRecommendation(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Last Update Time");
		field.setLocaleKey("product_recommendation.last_update_time");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField idFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Id");
		field.setLocaleKey("shipping_address.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField nameFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Name");
		field.setLocaleKey("shipping_address.name");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField line1FromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Line1");
		field.setLocaleKey("shipping_address.line1");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField line2FromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Line2");
		field.setLocaleKey("shipping_address.line2");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField cityFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("City");
		field.setLocaleKey("shipping_address.city");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField stateFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("State");
		field.setLocaleKey("shipping_address.state");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField zipCodeFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Zip Code");
		field.setLocaleKey("shipping_address.zip_code");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("number");
	...
	protected FormField idFromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Id");
		field.setLocaleKey("payment_method.id");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField nameFromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Name");
		field.setLocaleKey("payment_method.name");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField numberFromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Number");
		field.setLocaleKey("payment_method.number");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField line1FromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Line1");
		field.setLocaleKey("payment_method.line1");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField line2FromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Line2");
		field.setLocaleKey("payment_method.line2");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField cityFromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("City");
		field.setLocaleKey("payment_method.city");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField expireOnFromPaymentMethod(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Expire On");
		field.setLocaleKey("payment_method.expire_on");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("date");
		field.setRequired(true);
		field.setPlaceholder("请填写Expire On");
		return field;
	}
