...
@JsonSerialize(using = SearchExceptionJsonSerializer.class)
public class SearchException extends Exception implements MessageContainer {
    ...
    public SearchException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public SearchException(List<Message> messageList) {
        super();
