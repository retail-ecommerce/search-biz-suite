...
import com.doublechaintech.search.secuser.SecUserCustomManagerImpl;
...
public class SearchUserContextImpl extends UserContextImpl implements SearchUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.search.SearchResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.search.SearchCustomResources";
    ...
    /*
    public static SecUser getSecUser(SearchUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(SearchUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(SearchUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(SearchUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
