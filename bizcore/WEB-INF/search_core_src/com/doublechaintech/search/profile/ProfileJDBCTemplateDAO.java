...
public class ProfileJDBCTemplateDAO extends SearchNamingServiceDAO implements ProfileDAO{
	...
	*/
    ...
    public SmartList<Profile> requestCandidateProfileForUserOrder(SearchUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
