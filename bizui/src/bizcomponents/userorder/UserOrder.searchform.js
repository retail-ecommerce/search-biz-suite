...
import styles from './UserOrder.search.less'
...
class UserOrderSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userOrderList: 1,
      'userOrderList.searchField': fieldName,
      'userOrderList.searchVerb': 'startsWith',
      'userOrderList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`userOrderList.searchField`] = fieldName
    value[`userOrderList.searchVerb`] =  searchVerb
    value[`userOrderList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['userOrderList'] = 1
      params['userOrderList.orderBy.0'] = "id"
      params['userOrderList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        userOrderSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(UserOrderSearchForm)
