...
class UserOrderCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addUserOrder`,
          payload: { id: owner.id, type: 'userOrder', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'userOrder',listName:'User Order列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个User Order"
        content="新建一个User Order"
...
}))(Form.create()(UserOrderCreateForm))
