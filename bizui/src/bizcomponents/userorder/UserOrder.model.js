...
export default {
  ...
  effects: {
    ...
    *addLineItem({ payload }, { call, put }) {
      ...
      const location = { pathname: `/userOrder/${id}/list/\LineItemList/Line Item列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    ...
    *addOrderPromotion({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/userOrder/${id}/list/\OrderPromotionList/Order Promotion列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    ...
    *addManualAdjustment({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/userOrder/${id}/list/\ManualAdjustmentList/Manual Adjustment列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    ...
    *addShippingGroup({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/userOrder/${id}/list/\ShippingGroupList/Shipping Group列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    ...
    *addPaymentGroup({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/userOrder/${id}/list/\PaymentGroupList/Payment Group列表`, state: newState }
      yield put(routerRedux.push(location))
    },
