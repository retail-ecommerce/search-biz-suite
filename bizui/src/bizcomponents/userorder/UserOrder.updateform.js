...
class UserOrderUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, userOrderId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateUserOrder`,
          payload: {
            id: owner.id,
            type: 'userOrder',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextUserOrderUpdateRow`,
        payload: {
          id: owner.id,
          type: 'userOrder',
          selectedRows,
...
}))(Form.create()(UserOrderUpdateForm))
