...
class UserAppBizApp extends React.PureComponent {
  ...
  getObjectAccessSearch = () => {
    ...
    return connect(state => ({
      ...
      listDisplayName: 'Object Access列表' }, // this is for model namespace and
    }))(ObjectAccessSearch)
  }
  getObjectAccessCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._userApp.objectAccessSearchFormParameters,
      loading: state._userApp.loading,
      owner: { type: '_userApp', id: state._userApp.id, referenceName: 'app', listName: 'objectAccessList', ref:state._userApp, listDisplayName: 'Object Access列表'}, // this is for model namespace and
  ...
  getObjectAccessUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "objectAccess",
      currentUpdateIndex: state._userApp.currentUpdateIndex,
      owner: { type: '_userApp', id: state._userApp.id, listName: 'objectAccessList', ref:state._userApp, listDisplayName: 'Object Access列表' }, // this is for model namespace and
