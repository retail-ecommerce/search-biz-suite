...
class LevelOneCategoryBizApp extends React.PureComponent {
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/levelOneCategory/${this.props.levelOneCategory.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
  ...
  getLevelTwoCategorySearch = () => {
    ...
    return connect(state => ({
      ...
      listDisplayName: 'Level Two Category列表' }, // this is for model namespace and
  ...
  getLevelTwoCategoryCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._levelOneCategory.levelTwoCategorySearchFormParameters,
      loading: state._levelOneCategory.loading,
      owner: { type: '_levelOneCategory', id: state._levelOneCategory.id, referenceName: 'parentCategory', listName: 'levelTwoCategoryList', ref:state._levelOneCategory, listDisplayName: 'Level Two Category列表'}, // this is for model namespace and
  ...
  getLevelTwoCategoryUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_levelOneCategory', id: state._levelOneCategory.id, listName: 'levelTwoCategoryList', ref:state._levelOneCategory, listDisplayName: 'Level Two Category列表' }, // this is for model namespace and
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {LevelOneCategoryViewDetail} = GlobalComponents
