...
class LevelOneCategorySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      levelOneCategoryList: 1,
      'levelOneCategoryList.searchField': fieldName,
      'levelOneCategoryList.searchVerb': 'startsWith',
      'levelOneCategoryList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`levelOneCategoryList.searchField`] = fieldName
    value[`levelOneCategoryList.searchVerb`] =  searchVerb
    value[`levelOneCategoryList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['levelOneCategoryList'] = 1
      params['levelOneCategoryList.orderBy.0'] = "id"
      params['levelOneCategoryList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        levelOneCategorySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 targetType={"catalog"} 
                 requestFunction={LevelOneCategoryService.requestCandidateCatalog}/>
...
export default Form.create()(LevelOneCategorySearchForm)
