...
import styles from './OrderPromotion.search.less'
...
class OrderPromotionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      orderPromotionList: 1,
      'orderPromotionList.searchField': fieldName,
      'orderPromotionList.searchVerb': 'startsWith',
      'orderPromotionList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`orderPromotionList.searchField`] = fieldName
    value[`orderPromotionList.searchVerb`] =  searchVerb
    value[`orderPromotionList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['orderPromotionList'] = 1
      params['orderPromotionList.orderBy.0'] = "id"
      params['orderPromotionList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        orderPromotionSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={OrderPromotionService.requestCandidateUserOrder}/>
...
export default Form.create()(OrderPromotionSearchForm)
