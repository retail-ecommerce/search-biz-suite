...
class OrderPromotionTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/orderPromotion/${record.id}/dashboard`}>{'查看'}</Link>}
...
export default OrderPromotionTable
