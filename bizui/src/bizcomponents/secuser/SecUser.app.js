...
class SecUserBizApp extends React.PureComponent {
  ...
  getUserAppSearch = () => {
    ...
    return connect(state => ({
      ...
      listDisplayName: 'User App列表' }, // this is for model namespace and
    }))(UserAppSearch)
  }
  getUserAppCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._secUser.userAppSearchFormParameters,
      loading: state._secUser.loading,
      owner: { type: '_secUser', id: state._secUser.id, referenceName: 'secUser', listName: 'userAppList', ref:state._secUser, listDisplayName: 'User App列表'}, // this is for model namespace and
    }))(UserAppCreateForm)
  }
  ...
  getUserAppUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_secUser', id: state._secUser.id, listName: 'userAppList', ref:state._secUser, listDisplayName: 'User App列表' }, // this is for model namespace and
    }))(UserAppUpdateForm)
  }
  ...
  getLoginHistorySearch = () => {
    ...
    return connect(state => ({
      ...
      listDisplayName: 'Login History列表' }, // this is for model namespace and
    }))(LoginHistorySearch)
  }
  getLoginHistoryCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._secUser.loginHistorySearchFormParameters,
      loading: state._secUser.loading,
      owner: { type: '_secUser', id: state._secUser.id, referenceName: 'secUser', listName: 'loginHistoryList', ref:state._secUser, listDisplayName: 'Login History列表'}, // this is for model namespace and
  ...
  getLoginHistoryUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "loginHistory",
      currentUpdateIndex: state._secUser.currentUpdateIndex,
      owner: { type: '_secUser', id: state._secUser.id, listName: 'loginHistoryList', ref:state._secUser, listDisplayName: 'Login History列表' }, // this is for model namespace and
