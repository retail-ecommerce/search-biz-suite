...
const menuData = {menuName:"Manual Adjustment", menuFor: "manualAdjustment",
  		subItems: [
...
const displayColumns = [
  ...
  { title: 'Type', debugtype: 'string', dataIndex: 'type', width: '13',render: (text, record)=>renderTextCell(text,record) },
...
const ManualAdjustmentBase={menuData,displayColumns,fieldLabels,displayColumns}
export default ManualAdjustmentBase
