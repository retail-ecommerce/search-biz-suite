...
import styles from './LineItem.search.less'
...
class LineItemSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      lineItemList: 1,
      'lineItemList.searchField': fieldName,
      'lineItemList.searchVerb': 'startsWith',
      'lineItemList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`lineItemList.searchField`] = fieldName
    value[`lineItemList.searchVerb`] =  searchVerb
    value[`lineItemList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['lineItemList'] = 1
      params['lineItemList.orderBy.0'] = "id"
      params['lineItemList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        lineItemSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={LineItemService.requestCandidateUserOrder}/>
...
export default Form.create()(LineItemSearchForm)
