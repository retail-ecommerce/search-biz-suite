...
const menuData = {menuName:"Line Item", menuFor: "lineItem",
  		subItems: [
...
const displayColumns = [
  ...
  { title: 'Quantity', debugtype: 'int', dataIndex: 'quantity', width: '6',render: (text, record)=>renderTextCell(text,record) },
  { title: 'Price', dataIndex: 'price', className:'money', render: (text, record) => renderMoneyCell(text, record) },
  { title: 'Discount Price', dataIndex: 'discountPrice', className:'money', render: (text, record) => renderMoneyCell(text, record) },
