...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{lineItemList:selectedRows}} owner={owner}  
...
class LineItemSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {LineItemTable} = GlobalComponents;
    const {LineItemSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,LineItemModalTable,"lineItemIds")}
...
export default Form.create()(LineItemSearch)
