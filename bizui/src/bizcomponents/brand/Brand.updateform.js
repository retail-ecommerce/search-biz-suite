...
import styles from './Brand.updateform.less'
...
class BrandUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, brandId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextBrandUpdateRow`,
        payload: {
          id: owner.id,
          type: 'brand',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新Brand"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新Brand"
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.brandName} {...formItemLayout}>
                  {getFieldDecorator('brandName', {
                    initialValue: selectedRow.brandName,
                    rules: [{ required: true, message: '请输入Brand Name' }],
                  })(
            ...
            <Row gutter={16}>
              ...
              <Col lg={6} md={12} sm={24}>
                <ImageComponent
                  ...
                  handleChange={event => this.handleChange(event, 'logo')}
                  fileList={convertedImagesValues.logo}
                />
              </Col>
