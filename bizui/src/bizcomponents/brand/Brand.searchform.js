...
import styles from './Brand.search.less'
...
class BrandSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      brandList: 1,
      'brandList.searchField': fieldName,
      'brandList.searchVerb': 'startsWith',
      'brandList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`brandList.searchField`] = fieldName
    value[`brandList.searchVerb`] =  searchVerb
    value[`brandList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'brandName'))
      ...
      params['brandList'] = 1
      params['brandList.orderBy.0'] = "id"
      params['brandList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        brandSearchFormParameters: filterObjectKeys(fieldsValue),
       ...
       <Col md={8} sm={24}>
         <FormItem label="Brand Name">
           {getFieldDecorator('brandName')(
             <Input placeholder="请输入Brand Name" />
           )}
         </FormItem>
       </Col>
...
export default Form.create()(BrandSearchForm)
