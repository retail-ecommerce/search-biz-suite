...
const ViewMapping = {
  ...
  'com.doublechaintech.search.platform.Platform': {name:'platform'},
  'com.doublechaintech.search.userdomain.UserDomain': {name:'userDomain'},
  'com.doublechaintech.search.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.doublechaintech.search.secuser.SecUser': {name:'secUser'},
  'com.doublechaintech.search.secuserblocking.SecUserBlocking': {name:'secUserBlocking'},
  'com.doublechaintech.search.userapp.UserApp': {name:'userApp'},
  'com.doublechaintech.search.listaccess.ListAccess': {name:'listAccess'},
  'com.doublechaintech.search.objectaccess.ObjectAccess': {name:'objectAccess'},
  'com.doublechaintech.search.loginhistory.LoginHistory': {name:'loginHistory'},
