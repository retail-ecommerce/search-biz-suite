...
import styles from './ProductRecommendation.createform.less'
...
class ProductRecommendationCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addProductRecommendation`,
          payload: { id: owner.id, type: 'productRecommendation', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'productRecommendation',listName:'Product Recommendation列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个Product Recommendation"
        content="新建一个Product Recommendation"
...
}))(Form.create()(ProductRecommendationCreateForm))
