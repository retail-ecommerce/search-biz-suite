...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{productRecommendationList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'brand')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'brand')}/> <ProductAssociateForm 
...
class ProductRecommendationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ProductRecommendationTable} = GlobalComponents;
    const {ProductRecommendationSearchForm} = GlobalComponents;
    const {ProductRecommendationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ProductRecommendationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ProductRecommendationModalTable,"productRecommendationIds")}
...
export default Form.create()(ProductRecommendationSearch)
