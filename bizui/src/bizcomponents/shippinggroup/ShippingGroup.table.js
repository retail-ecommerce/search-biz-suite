...
class ShippingGroupTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/shippingGroup/${record.id}/dashboard`}>{'查看'}</Link>}
...
export default ShippingGroupTable
