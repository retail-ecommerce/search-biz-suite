...
class ShippingGroupSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      shippingGroupList: 1,
      'shippingGroupList.searchField': fieldName,
      'shippingGroupList.searchVerb': 'startsWith',
      'shippingGroupList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`shippingGroupList.searchField`] = fieldName
    value[`shippingGroupList.searchVerb`] =  searchVerb
    value[`shippingGroupList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'country'))
      ...
      params['shippingGroupList'] = 1
      params['shippingGroupList.orderBy.0'] = "id"
      params['shippingGroupList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        shippingGroupSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ShippingGroupSearchForm)
