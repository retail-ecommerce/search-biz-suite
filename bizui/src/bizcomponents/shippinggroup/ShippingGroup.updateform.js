...
class ShippingGroupUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, shippingGroupId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateShippingGroup`,
          payload: {
            id: owner.id,
            type: 'shippingGroup',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextShippingGroupUpdateRow`,
        payload: {
          id: owner.id,
          type: 'shippingGroup',
          selectedRows,
...
}))(Form.create()(ShippingGroupUpdateForm))
