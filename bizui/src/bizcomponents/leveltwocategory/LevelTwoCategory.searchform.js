...
class LevelTwoCategorySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      levelTwoCategoryList: 1,
      'levelTwoCategoryList.searchField': fieldName,
      'levelTwoCategoryList.searchVerb': 'startsWith',
      'levelTwoCategoryList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`levelTwoCategoryList.searchField`] = fieldName
    value[`levelTwoCategoryList.searchVerb`] =  searchVerb
    value[`levelTwoCategoryList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['levelTwoCategoryList'] = 1
      params['levelTwoCategoryList.orderBy.0'] = "id"
      params['levelTwoCategoryList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        levelTwoCategorySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 requestFunction={LevelTwoCategoryService.requestCandidateParentCategory}/>
...
export default Form.create()(LevelTwoCategorySearchForm)
