...
class LevelTwoCategoryDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, levelNCategoryListMetaInfo, levelNCategoryCount } = this.props.levelTwoCategory
    ...
    const cardsData = {cardsName:"Level Two Category",cardsFor: "levelTwoCategory",
    	cardsSource: this.props.levelTwoCategory,returnURL,displayName,
  		subItems: [
{name: 'levelNCategoryList', displayName:'Level N Category',type:'levelNCategory',count:levelNCategoryCount,addFunction: true, role: 'levelNCategory', metaInfo: levelNCategoryListMetaInfo},
