...
class LevelTwoCategoryCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addLevelTwoCategory`,
          payload: { id: owner.id, type: 'levelTwoCategory', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'levelTwoCategory',listName:'Level Two Category列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个Level Two Category"
        content="新建一个Level Two Category"
...
}))(Form.create()(LevelTwoCategoryCreateForm))
