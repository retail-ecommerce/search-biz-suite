...
class LevelTwoCategoryAssociateForm extends Component {
  state = {
 ...
 <Modal
	...
	<LevelNCategoryModalTable data={data.levelNCategoryList} owner={owner} />
...
}))(Form.create()(LevelTwoCategoryAssociateForm))
