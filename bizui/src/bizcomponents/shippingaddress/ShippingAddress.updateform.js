...
import styles from './ShippingAddress.updateform.less'
...
class ShippingAddressUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const shippingAddressId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, shippingAddressId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateShippingAddress`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextShippingAddressUpdateRow`,
        payload: {
          id: owner.id,
          type: 'shippingAddress',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新Shipping Address"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新Shipping Address"
...
}))(Form.create()(ShippingAddressUpdateForm))
