...
class ShippingAddressCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addShippingAddress`,
          payload: { id: owner.id, type: 'shippingAddress', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'shippingAddress',listName:'Shipping Address列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个Shipping Address"
        content="新建一个Shipping Address"
...
}))(Form.create()(ShippingAddressCreateForm))
