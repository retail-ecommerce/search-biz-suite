...
import styles from './Site.table.less'
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/site/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
