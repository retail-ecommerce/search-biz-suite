...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{siteList:selectedRows}} owner={owner}  
...
class SiteSearch extends PureComponent {
  ...
  render(){
    ...
    const {SiteTable} = GlobalComponents;
    const {SiteSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,SiteModalTable,"siteIds")}
...
export default Form.create()(SiteSearch)
