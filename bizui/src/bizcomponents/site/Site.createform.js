...
import styles from './Site.createform.less'
...
/*
const testValues = {
  name: 'The first customer site',
  introduction: 'The primary site for show the concept',
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addSite`,
          payload: { id: owner.id, type: 'site', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'site',listName:appLocaleName(userContext,"List") },
      })
    }
