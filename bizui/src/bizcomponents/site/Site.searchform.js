...
import styles from './Site.search.less'
...
class SiteSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      siteList: 1,
      'siteList.searchField': fieldName,
      'siteList.searchVerb': 'startsWith',
      'siteList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`siteList.searchField`] = fieldName
    value[`siteList.searchVerb`] =  searchVerb
    value[`siteList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['siteList'] = 1
      params['siteList.orderBy.0'] = "id"
      params['siteList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        siteSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={SiteService.requestCandidatePlatform}/>
...
export default Form.create()(SiteSearchForm)
