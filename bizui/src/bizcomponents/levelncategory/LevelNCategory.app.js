...
class LevelNCategoryBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/levelNCategory/${this.props.levelNCategory.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/levelNCategory/${this.props.levelNCategory.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getProductCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._levelNCategory.productSearchFormParameters,
      loading: state._levelNCategory.loading,
      owner: { type: '_levelNCategory', id: state._levelNCategory.id, referenceName: 'parentCategory', listName: 'productList', ref:state._levelNCategory, listDisplayName: 'Product列表'}, // this is for model namespace and
    }))(ProductCreateForm)
  }
  ...
  getProductUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_levelNCategory', id: state._levelNCategory.id, listName: 'productList', ref:state._levelNCategory, listDisplayName: 'Product列表' }, // this is for model namespace and
    }))(ProductUpdateForm)
  }
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {LevelNCategoryEditDetail} = GlobalComponents
     //const {LevelNCategoryViewDetail} = GlobalComponents
