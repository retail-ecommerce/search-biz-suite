...
const displayColumns = [
  ...
  { title: 'Display Name', debugtype: 'string', dataIndex: 'displayName', width: '15',render: (text, record)=>renderTextCell(text,record) },
...
const LevelNCategoryBase={menuData,displayColumns,fieldLabels,displayColumns}
