...
import styles from './LevelNCategory.search.less'
...
class LevelNCategorySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      levelNCategoryList: 1,
      'levelNCategoryList.searchField': fieldName,
      'levelNCategoryList.searchVerb': 'startsWith',
      'levelNCategoryList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`levelNCategoryList.searchField`] = fieldName
    value[`levelNCategoryList.searchVerb`] =  searchVerb
    value[`levelNCategoryList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['levelNCategoryList'] = 1
      params['levelNCategoryList.orderBy.0'] = "id"
      params['levelNCategoryList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        levelNCategorySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 requestFunction={LevelNCategoryService.requestCandidateParentCategory}/>
...
export default Form.create()(LevelNCategorySearchForm)
