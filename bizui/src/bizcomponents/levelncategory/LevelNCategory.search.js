...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{levelNCategoryList:selectedRows}} owner={owner}  
...
class LevelNCategorySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {LevelNCategoryTable} = GlobalComponents;
    const {LevelNCategorySearchForm} = GlobalComponents;
    const {LevelNCategoryModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <LevelNCategorySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,LevelNCategoryModalTable,"levelNCategoryIds")}
...
export default Form.create()(LevelNCategorySearch)
