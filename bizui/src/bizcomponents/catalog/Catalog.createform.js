...
class CatalogCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addCatalog`,
          payload: { id: owner.id, type: 'catalog', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'catalog',listName:'Catalog列表' },
      })
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.site} {...formItemLayout}>
                  {getFieldDecorator('siteId', {
                    ...
                    rules: [{ required: true, message: '请输入Site' }],
                  })(
