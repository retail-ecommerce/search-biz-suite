...
import styles from './Catalog.search.less'
...
class CatalogSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      catalogList: 1,
      'catalogList.searchField': fieldName,
      'catalogList.searchVerb': 'startsWith',
      'catalogList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`catalogList.searchField`] = fieldName
    value[`catalogList.searchVerb`] =  searchVerb
    value[`catalogList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['catalogList'] = 1
      params['catalogList.orderBy.0'] = "id"
      params['catalogList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        catalogSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(CatalogSearchForm)
