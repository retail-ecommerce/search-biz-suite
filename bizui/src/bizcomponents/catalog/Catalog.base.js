...
const menuData = {menuName:"Catalog", menuFor: "catalog",
  		subItems: [
  {name: 'levelOneCategoryList', displayName:'Level One Category', icon:'at',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false},
...
const displayColumns = [
  { title: 'Id', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderTextCell(text,record,'catalog') },
...
const CatalogBase={menuData,displayColumns,fieldLabels}
