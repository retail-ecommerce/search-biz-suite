...
class ProfileBizApp extends React.PureComponent {
  ...
  getUserOrderSearch = () => {
    ...
    return connect(state => ({
      ...
      name: "User Order",
      role: "userOrder",
      data: state._profile.userOrderList,
      metaInfo: state._profile.userOrderListMetaInfo,
      count: state._profile.userOrderCount,
      currentPage: state._profile.userOrderCurrentPageNumber,
      searchFormParameters: state._profile.userOrderSearchFormParameters,
      ...
      referenceName: 'user', 
      listName: 'userOrderList', ref:state._profile, 
  ...
  getUserOrderCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._profile.userOrderSearchFormParameters,
      loading: state._profile.loading,
      owner: { type: '_profile', id: state._profile.id, referenceName: 'user', listName: 'userOrderList', ref:state._profile, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(UserOrderCreateForm)
  }
  ...
  getUserOrderUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_profile', id: state._profile.id, listName: 'userOrderList', ref:state._profile, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(UserOrderUpdateForm)
  }
  ...
  buildRouters = () =>{
  	...
  	{path:"/profile/:id/list/userOrderList", component: this.getUserOrderSearch()},
  	{path:"/profile/:id/list/userOrderCreateForm", component: this.getUserOrderCreateForm()},
  	{path:"/profile/:id/list/userOrderUpdateForm", component: this.getUserOrderUpdateForm()},
