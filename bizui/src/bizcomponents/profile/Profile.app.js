...
class ProfileBizApp extends React.PureComponent {
  ...
  getUserOrderCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._profile.userOrderSearchFormParameters,
      loading: state._profile.loading,
      owner: { type: '_profile', id: state._profile.id, referenceName: 'user', listName: 'userOrderList', ref:state._profile, listDisplayName: 'User Order列表'}, // this is for model namespace and
    }))(UserOrderCreateForm)
  }
  ...
  getUserOrderUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_profile', id: state._profile.id, listName: 'userOrderList', ref:state._profile, listDisplayName: 'User Order列表' }, // this is for model namespace and
    }))(UserOrderUpdateForm)
  }
