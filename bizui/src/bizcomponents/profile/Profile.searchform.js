...
import styles from './Profile.search.less'
...
class ProfileSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      profileList: 1,
      'profileList.searchField': fieldName,
      'profileList.searchVerb': 'startsWith',
      'profileList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`profileList.searchField`] = fieldName
    value[`profileList.searchVerb`] =  searchVerb
    value[`profileList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'gender'))
      ...
      params['profileList'] = 1
      params['profileList.orderBy.0'] = "id"
      params['profileList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        profileSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ProfileSearchForm)
