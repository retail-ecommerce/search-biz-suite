...
import styles from './Profile.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, profileId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextProfileUpdateRow`,
        payload: {
          id: owner.id,
          type: 'profile',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新Profile"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新Profile"
