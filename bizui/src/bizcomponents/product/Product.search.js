...
class ProductSearch extends PureComponent {
  ...
  render(){
    ...
    const {ProductTable} = GlobalComponents;
    const {ProductSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,ProductModalTable,"productIds")}
