...
import styles from './Product.search.less'
...
class ProductSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      productList: 1,
      'productList.searchField': fieldName,
      'productList.searchVerb': 'startsWith',
      'productList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`productList.searchField`] = fieldName
    value[`productList.searchVerb`] =  searchVerb
    value[`productList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['productList'] = 1
      params['productList.orderBy.0'] = "id"
      params['productList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        productSearchFormParameters: filterObjectKeys(fieldsValue),
