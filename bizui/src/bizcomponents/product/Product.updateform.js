...
import styles from './Product.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, productId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextProductUpdateRow`,
        payload: {
          id: owner.id,
          type: 'product',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新Product"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新Product"
