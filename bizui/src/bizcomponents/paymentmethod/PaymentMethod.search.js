...
class PaymentMethodSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {PaymentMethodTable} = GlobalComponents;
    const {PaymentMethodSearchForm} = GlobalComponents;
    const {PaymentMethodModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <PaymentMethodSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,PaymentMethodModalTable,"paymentMethodIds")}
...
export default Form.create()(PaymentMethodSearch)
