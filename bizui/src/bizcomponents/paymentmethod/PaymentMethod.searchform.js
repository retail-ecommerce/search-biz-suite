...
import styles from './PaymentMethod.search.less'
...
class PaymentMethodSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      paymentMethodList: 1,
      'paymentMethodList.searchField': fieldName,
      'paymentMethodList.searchVerb': 'startsWith',
      'paymentMethodList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`paymentMethodList.searchField`] = fieldName
    value[`paymentMethodList.searchVerb`] =  searchVerb
    value[`paymentMethodList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['paymentMethodList'] = 1
      params['paymentMethodList.orderBy.0'] = "id"
      params['paymentMethodList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        paymentMethodSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(PaymentMethodSearchForm)
