...
class PaymentMethodUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, paymentMethodId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updatePaymentMethod`,
          payload: {
            id: owner.id,
            type: 'paymentMethod',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextPaymentMethodUpdateRow`,
        payload: {
          id: owner.id,
          type: 'paymentMethod',
          selectedRows,
...
}))(Form.create()(PaymentMethodUpdateForm))
