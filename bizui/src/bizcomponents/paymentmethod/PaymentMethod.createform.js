...
class PaymentMethodCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addPaymentMethod`,
          payload: { id: owner.id, type: 'paymentMethod', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'paymentMethod',listName:'Payment Method列表' },
      })
    }
    ...
    return (
      <PageHeaderLayout
        title="新建一个Payment Method"
        content="新建一个Payment Method"
...
}))(Form.create()(PaymentMethodCreateForm))
